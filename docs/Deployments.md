...
| Current public HEAD runtime | `22,367` bytes |
...
history, and the current public HEAD recompiles `WalletWallVault` to a `22,367`-byte
...
| Repo package version (this PR) | `0.10.11` |
